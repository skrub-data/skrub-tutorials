...
It is also possible to define custom filters to select only specific columns:
...
The `TableReport` can be exported in

- standalone **HTML**, to retain interactivity
- **JSON**, for programmatic access
- **Markdown**, to obtain a shortened textual summary of the content (next release!)
...
- Saving and exporting reports as HTML, JSON, and Markdown files
