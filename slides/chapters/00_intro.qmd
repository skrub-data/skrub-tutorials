...
- The material is split in sections that contain two or more chapters
...
1. Explore data with `TableReport`
2. Clean data with `Cleaner`
3. Select & transform columns with selectors
4. Engineer features: numerical, datetime, categorical
5. Combine everything: `TableVectorizer` & `tabular_pipeline`
